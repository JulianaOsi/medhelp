...
INSERT INTO direction (id, patient_id, doctor_id, date, icd_code, medical_organization) 
VALUES 
       (0, 0, 0, '2020-11-13 12:00', 'K29', 'Поликлиника №5'),
	   (1, 1, 1, '2020-11-13 12:30', 'E10-E14', 'Поликлиника №6'),
       (2, 2, 2, '2020-11-13 14:00', 'N20-N23', 'Поликлиника №1'),
       (3, 3, 0, '2020-11-15 10:00', 'K29', 'Поликлиника №6'),
       (4, 4, 1, '2020-11-15 11:15', 'E10-E14', 'Поликлиника №5'),
       (5, 5, 2, '2020-11-14 14:00', 'N20-N23', 'Поликлиника №1'),
       (6, 6, 1, '2020-11-13 15:00', 'E10-E14', 'Поликлиника №5');
